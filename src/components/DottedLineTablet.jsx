        ...
        <div className="flex flex-col gap-16 mb-10">
          <div className="flex items-center justify-center gap-4 mb-4">
            {items.slice(0, 3).map((item, index) => (
              <div
                key={index}
                className="relative flex flex-col items-center justify-center p-4 text-center bg-[#2E2266] rounded-lg shadow-lg h-44 w-44"
              >
                <div className="mt-2 mb-4 font-semibold text-center text-white text-md ">
                  {item.title}
                </div>
                <div className="mb-4 text-sm text-center text-white/80 w-36">
                  {item.description}
                </div>

                <div className="absolute bottom-[-36px] left-1/2 transform -translate-x-1/2  text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg bg-white/10 backdrop-blur-2xl">
                  <img
                ...
                <div className="absolute left-[90px]  top-[210px] bottom-[80px] transform -translate-x-1/2 border-l-2 border-dotted border-[#E8D8FF] h-24" />
              </div>
            ))}
          </div>

          <div className="relative w-full h-1 mb-4 bg-dotted-line">
            <div className="absolute top-1/2  transform -translate-y-1/2  text-white rounded-full p-4 items-center justify-center hidden md:flex border-[#2E2266] border-2 bg-white">
              <img
            ...
            {/* Dotted line */}
            <div className="absolute top-1/2 left-[calc(0px+4rem)] right-[calc(20px+4rem)] transform -translate-y-1/2 border-t-2 border-dotted border-[#E8D8FF] w-5/6" />
            <div className="absolute top-1/2 right-[0px] transform -translate-y-1/2 border-[#2E2266] border-2 bg-white text-white rounded-full p-4 items-center justify-center hidden md:flex">
              <img
          ...
          <div className="flex justify-center gap-4">
            {items.slice(3).map((item, index) => (
              <div
                key={index}
                className="relative flex flex-col items-center justify-center h-48 p-4 text-center bg-white rounded-lg shadow-lg w-44"
              >
                ...
                <div className="absolute top-[-36px] left-1/2 transform -translate-x-1/2  text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg bg-white/10 backdrop-blur-2xl">
                  <img
                    src={`./${imagePath}${item.imageUrl}`}
                    alt="Item image"
                    className="w-6 h-6"
